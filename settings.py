# Settings: Ultron's AI Components

# Matthew Umahag ID
muID = 239116660592738304
...
#   Ultron AI Full Reset:
#     Command: umahag override -mu ai full reset
#     Permission Level: Matthew Umahag
#     Description: Full Reset of Ultron AI instances

#   Ultron AI User Conversation Powerdown:
#     Command: ultron power down
#     Permission Level: User
#     Description: Shutdown user Ultron AI instance

#   Ultron Full Robot Restart:
#     Command: umahag override -mu full bot restart or ultron activate fantastic spider protocol
#     Permission Level: Matthew Umahag
#     Description: Shutdown and restart all Ultron services
